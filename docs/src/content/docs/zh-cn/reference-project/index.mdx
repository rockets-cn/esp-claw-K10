...
<FileTree>
- application/basic_demo/ **示例应用** — 把框架与 cap 装配成可烧录固件
  - main/ 启动、Wi‑Fi、HTTP 配置页、`app_claw_start`
    - main.c 固件入口
    - app_claw.c 应用启动与装配
    ...
    - web/ 设备配置前端资源
  - components/display_arbiter/ 显示所有权仲裁 [\[详情\]](@lang/reference-cap/lua-modules#显示模块)
  - fatfs_image/ 出厂 FATFS：skills、router_rules、memory、scripts 样例
- components/
  - claw_modules/ **运行时核心**
