...
<CardGrid>
  ...
  <LinkCard title="cap_im_tg" href="./cap-im-tg" description="IM 接入代表：事件源 + 可调用工具的双重角色" />
  ...
  <LinkCard title="cap_files" href="./cap-files" description="文件系统代表：受管目录的完整 CRUD 能力" />
  ...
  <LinkCard title="Lua 扩展模块" href="./lua-modules" description="lua_module_* 的注册机制、实现方式与 display 模块分析" />
</CardGrid>
