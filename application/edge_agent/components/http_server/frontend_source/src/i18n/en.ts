export const en = {
  ...
  webimDesc:
    'Live assistant replies over WebSocket; messages exist only in this browser tab until you refresh. Images upload as files then send as links.',
  webimSend: 'Send',
  ...
  webimEmpty: 'No messages in this tab yet.',
  webimPendingFiles: 'Attachments pending send',
  webimUploaded: 'Image uploaded — click Send to post.',
  webimLiveHint:
    'Conversation is kept only in memory in this browser; refreshing the page clears it. Assistant output is pushed live over WebSocket.',
  webimWsConnected: 'Live channel connected (WebSocket).',
  ...
  capabilityLlmVisible: 'LLM visible',
  capabilityDefaultLlm: 'Default: LLM-visible',
  capabilityNoResult: 'No capability matches the current filter.',

  sectionSkills: 'Lua Modules',
  skillsDescription:
    'Select which compiled Lua modules are registered when cap_lua starts. Changes take effect after restart.',
  skillsSearchPlaceholder: 'Search modules…',
  skillsSummary: '{enabled} enabled / {total} total',
  skillsSelectAll: 'Select All',
  skillsClearAll: 'Clear All',
  skillsLoading: 'Loading Lua modules…',
  skillsLoadError: 'Failed to load Lua modules',
  skillsCapabilityRequired:
    'Enable the cap_lua capability group before Lua module selection takes effect.',
  skillsNoResult: 'No Lua module matches the current filter.',
